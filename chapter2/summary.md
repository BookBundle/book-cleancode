...
2. [그릇된 정보를 피하라](#2)
3. [의미 있게 구분하라](#3)
4. [발음하기 쉬운 이름을 사용하라](#4)
5. [검색하기 쉬운 이름을 사용하라](#5)
6. [인코딩을 피하라](#6)
   1. [헝가리식 표기법](#7)
   2. [멤버 변수 접두어](#8)
   3. [인터페이스 클래스와 구현 클래스](#9)
10. [자신의 기억력을 자랑하지 마라](#10)
11. [클래스 이름](#11)
12. [메서드 이름](#12)
13. [기발한 이름은 피하라](#13)
14. [한 개념에 한 단어를 사용하라](#14)
15. [말장난을 하지 마라](#15)
16. [해법 영역 용어를 사용하라](#16)
17. [문제 영역 용어를 사용하라](#17)
18. [의미 있는 맥락을 추가하라](#18)
19. [불필요한 맥락을 없애라](#19)


## <a name = '1'> 의도를 분명히 밝혀라 p.22 </a>
...
## <a name = '4'> 발음하기 쉬운 이름을 사용하라 p.27 </a>
...
## <a name = '5'> 검색하기 쉬운 이름을 사용하라 p.28 </a>

- 변수 이름의 길이는 범위 크기에 비례해서 길어진다.

## <a name = '6'> 인코딩을 피하라 p.29 </a>
...
## <a name = '19'> 불필요한 맥락을 없애라 p.37 </a>
- `Gas Station Delux` 이라는 애플리케이션을 작성한다고 해서 클래스 이름의 앞에 `GSD`를 붙이는 것은 좋지 않다.
