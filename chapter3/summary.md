...
1. [한 가지만 해라!](#3)
    1. [함수 내 섹션](#4)
1. [함수 당 추상화 수준은 하나로!](#5)
    1. [위에서 아래로 코드 읽기 : 내려가기 규칙](#6)
1. [Switch문](#7)
1. [서술적인 이름을 사용하라!](#8)
1. [함수 인수](#9)
    1. [많이 쓰는 단항 형식](#10)
...
1. [부수 효과를 일으키지 마라!](#17)
    1. [출력 인수](#18)
1. [명령과 조회를 분리하라!](#19)
1. [오류코드보다 예외를 사용하라!](#20)
    1. [Try/Catch 블록 뽑아내기](#21)
    1. [오류 처리도 한 가지 작업이다](#22)
    1. [Error.java의 의존성 자석](#23)
1. [반복하지마라!](#24)
1. [구조적 프로그래밍](#25)
1. [함수를 어떻게 짜죠?](#26)
...
## <a name = '5'> 함수 당 추상화 수준은 하나로! p.45 </a>

- 지정된 함수 이름 아래에서 추상화 수준이 하나인 단계만 수행한다면 그 함수는 한 가지 작업만 하는 것이다.

### <a name = '6'> 위에서 아래로 코드 읽기 : 내려가기 규칙 </a>

- 코드는 위에서 아래로 읽혀야 좋다.
- 함수 추상화 부분이 한 번에 한 단계씩 낮아지는 것이 가장 이상적이다.(내려가기 규칙)

## <a name = '7'> Switch문 p.47 </a>
...
## <a name = '17'> 부수 효과를 일으키지 마라! p.54 </a>
...
## <a name = '19'> 명령과 조회를 분리하라! p.56 </a>

- 함수는 수행하거나 답하거나 둘 중 하나만 해야한다.
- 둘 다 수행해서는 안된다.

## <a name = '20'> 오류코드보다 예외를 사용하라! p.57 </a>


### <a name = '21'> Try/Catch 블록 뽑아내기 </a>
...
### <a name = '22'> 오류 처리도 한 가지 작업이다 </a>

- 오류 처리도 '한 가지' 작업에 속하므로 오류를 처리하는 함수는 오류만 처리해야 마땅하다.

### <a name = '23'> Error.java의 의존성 자석 </a>
...
## <a name = '24'> 반복하지마라! p.60 </a>

- 중복은 소프트웨어에서 모든 악의 근원이다.
- 중복을 없애도록 지속적으로 노력한다.

## <a name = '25'> 구조적 프로그래밍 p.61 </a>
